...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
  <div class="max-w-md w-full">
    <div>
     ...
     <div class="border-solid px-4 py-2 mt-4 border-gray-600 border rounded w-1/2 mx-auto flex items-center cursor-pointer" @click="googleLogin">
       <img src="https://cdn4.iconfinder.com/data/icons/new-google-logo-2015/400/new-google-favicon-512.png" alt="" class="w-6 mr-4">
       Login With Google
     </div>
    </div>
